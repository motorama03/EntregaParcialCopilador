    ...
    private $afd;
        ...
        public function __construct(){
            $this->afd = array(
                ...
                18=>['ACTION'=>['operadordeatribuicao'=>'S 19'],'GOTO'=>[]],
...
// Testando
/*$slr = new SLR();
$entrada = array('programa','id','ap','fp','ab','id','operadordeatribuicao','id','mais','id','menos','id','pv','print','ap','id','fp','pv','fb','$'); // considerar que cada 
